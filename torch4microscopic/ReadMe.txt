...
この torch4microscopic アプリケーションは、AppWizard により作成されました。
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、torch4microscopic.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
